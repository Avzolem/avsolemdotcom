  ...
  return (
    <>
      <div className="flex flex-col w-full gap-6">
        ...
        >
          {loading ? t('whatsapp.sending') : t('whatsapp.sendButton')}
        </button>
      </div>

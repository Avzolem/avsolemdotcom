...
import { getUserStats, deleteUserLists } from '@/lib/mongodb/models/MagicList';
import { deleteUserDecks } from '@/lib/mongodb/models/MagicDeck';
...
// DELETE: Delete user account and all Magic data
export async function DELETE(request: NextRequest) {
  try {
    ...
    // Delete all user Magic lists
    await deleteUserLists(session.user.id);

    // Delete all user Magic decks
    await deleteUserDecks(session.user.id);

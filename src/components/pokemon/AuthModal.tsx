...
export default function AuthModal({ isOpen, onClose, initialMode = 'login' }: AuthModalProps) {
  const { t, language } = usePokemonLanguage();
  const { signInWithGoogle, signInWithCredentials, register } = usePokemonAuth();
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          {mode === 'register' && (
            <div className={styles.field}>
              <label htmlFor="pokemon-name">{t('auth.name')}</label>
              <input
                id="pokemon-name"
                type="text"
                value={name}
          ...
          <div className={styles.field}>
            <label htmlFor="pokemon-email">{t('auth.email')}</label>
            <input
              id="pokemon-email"
              type="email"
              value={email}
          ...
          <div className={styles.field}>
            <label htmlFor="pokemon-password">{t('auth.password')}</label>
            <input
              id="pokemon-password"
              type="password"
              value={password}
          ...
          {mode === 'register' && (
            <>
              <div className={styles.field}>
                <label htmlFor="pokemon-confirmPassword">{t('auth.confirmPassword')}</label>
                <input
                  id="pokemon-confirmPassword"
                  type="password"
              ...
              <div className={styles.checkbox}>
                <input
                  id="pokemon-newsletter"
                  type="checkbox"
                  checked={subscribeNewsletter}
                  onChange={(e) => setSubscribeNewsletter(e.target.checked)}
                  disabled={isLoading}
                />
                <label htmlFor="pokemon-newsletter">

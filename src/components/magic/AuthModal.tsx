...
export default function AuthModal({ isOpen, onClose, initialMode = 'login' }: AuthModalProps) {
  ...
  const { signInWithGoogle, signInWithCredentials, register } = useMagicAuth();
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          {mode === 'register' && (
            <div className={styles.field}>
              <label htmlFor="magic-name">{t('auth.name')}</label>
              <input
                id="magic-name"
                type="text"
                value={name}
          ...
          <div className={styles.field}>
            <label htmlFor="magic-password">{t('auth.password')}</label>
            <input
              id="magic-password"
              type="password"
              value={password}
          ...
          {mode === 'register' && (
            <>
              <div className={styles.field}>
                <label htmlFor="magic-confirmPassword">{t('auth.confirmPassword')}</label>
                <input
                  id="magic-confirmPassword"
                  type="password"
              ...
              <div className={styles.checkbox}>
                <input
                  ...
                  disabled={isLoading}
                />
                <label htmlFor="magic-newsletter">
